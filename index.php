...
if(!$ajax) {
	...
	<head>
		...
		<meta property="og:url" content="<?=make_url($res['url'], array_merge($GLOBALS['filter'], ["domaine" => true]))?>">
		...
		<?php if(@$GLOBALS['icons']) {?><link rel="stylesheet" href="<?=$GLOBALS['icons']?>"><?php } else {?>
		<style>
			@font-face {
