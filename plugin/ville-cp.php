...
$sel = $connect->query("SELECT ville_code_commune, ville_nom_reel, ville_code_postal FROM villes_france_free WHERE ".($_GET['type'] == "ville" ? "ville_nom_simple" : "ville_code_postal")." LIKE '".$term."%' LIMIT 50");
